(function() {
	 ...
	 * @name tpmifix.util
	 */
	angular.module('tpmifix.util', [])

	/**
	 * @description
	 * Util constant.
	 *
	 * @memberof tpmifix.util
	 */
	...
	.factory('diffUtil', [
		...
		function() {
			 ...
			 *
			 * @example
			 * tpUtil.diffUtil.compareVersion('1.0.0', '1.1.0', {zeroExtend: true});  // return `-1`
			 * tpUtil.diffUtil.compareVersion('1.0.0', '1.0', {zeroExtend: true});  // return `0`
			 *
			 * @memberof diffUtil
	 ...
	 * Cut service.
	 *
	 * Afford some utils to cut or truncate data.
	 *
	 * @memberof tpmifix.util
	 * @ngdoc service
	 * @name cutUtil
	 ...
	 * Date-Time service.
	 *
	 * Afford some utils to process date-time, like unit convert...
	 *
	 * @memberof tpmifix.util
	 * @ngdoc service
	 * @name dateTimeUtil
	 ...
	 * Flow service.
	 *
	 * Afford some utils to process flow data, like unit convert...
	 *
	 * @memberof tpmifix.util
	 * @ngdoc service
	 * @name flowUtil
	 ...
	 * Util bundle.
	 *
	 * Bundle all utils into one util.
	 * Other module can depend on `tpUtil` and use any API under it, like `tpUtil.xxx.yyy()`.
	 * Html can use `tpUtil.xxx.yyy()` directly as it has been exported to `$rootScope`.
	 *
	 * @example
	 * tpUtil.checkUtil.checkLoginPasswordValid("123456");
	 *
	 * @memberof tpmifix.util
	 * @ngdoc service
	 * @name tpUtil
	 ...
	 * @requires flowUtil
	 */
	.factory('tpUtil', ['$rootScope', '$window', 'utilConstant', 'utilValue', 'initUtil', 'sortUtil', 'diffUtil', 'checkUtil', 'cutUtil', 'dateTimeUtil', 'flowUtil',
