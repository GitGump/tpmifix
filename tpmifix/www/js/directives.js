(function() {
	 ...
	 * @memberof tpmifix
	 * @ngdoc overview
	 * @name tpmifix.directive
	 * @requires tpmifix.util
	 */
	angular.module('tpmifix.directive', ['tpmifix.util'])
			...
			return {
				...
				link: function(scope, elm, attrs, ctrl) {
					ctrl.$validators.checkLoginPassword = function(modelValue, viewValue) {
						if (checkUtil.loginPassword.valid(viewValue)) {
							return true;
						} else {
							return false;
						}
